...
vector<float> util::apply_euler_frame_rotation(vector<float> point, vector<float> euler_angles) {
    vector<float> res;
...
vector<float> util::apply_frame_translation(vector<float> point, vector<float> translations) {
    vector<float> res;
